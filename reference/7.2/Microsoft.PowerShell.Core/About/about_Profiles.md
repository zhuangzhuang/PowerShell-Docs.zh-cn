...
|当前用户，所有主机   |$Home \\ [My] 文档 \\ PowerShell \\Profile.ps1 |
|当前用户、当前主机|$Home \\ [My] 文档 \\ PowerShell\\<br>Microsoft.PowerShell_profile.ps1 |
...
此外，托管 PowerShell 的其他程序可以支持其自己的配置文件。 例如，Visual Studio Code 支持以下特定于主机的配置文件。

|说明               | 路径                                     |
|--------------------------|------------------------------------------|
|所有用户，当前主机   |$PSHOME \\Microsoft.VSCode_profile.ps1|
|当前用户、当前主机|$Home \\ [My] 文档 \\ PowerShell\\<br>Microsoft.VSCode_profile.ps1|
